...
3. **Code Review** - Automated code reviews with SOLID, DRY, KISS, security checks; opt-in **Backward Compatibility
   Audit** for API, REST, DTO, config, crypto, and JPA contract changes
...
Auto-detects: Java/Maven, Java/Gradle, Node.js, Python, Go. Writes `.github/copilot-config.yml` and updates
`.gitignore`.
